...
** DOING Add E2E test for legacy project opening
:PROPERTIES:
...
*** Acceptance Criteria
- [ ] E2E test opens a project with legacy manifest mock
- [ ] No error banner or error message is visible
- [ ] Project name and version are correctly displayed/loaded
