...
** DONE Fix reactive dependency in EditorArea chapter/note effects
:PROPERTIES:
:CUSTOM_ID: ITEM-205
...
** DONE Write cross-type tab switching E2E tests
:PROPERTIES:
:CUSTOM_ID: ITEM-206
...
*** Acceptance Criteria
- [X] Test: clicking entity when chapter is active switches to entity tab
- [X] Test: clicking entity when note is active switches to entity tab
- [X] Test: clicking different entities switches active tab
- [X] Test: can return to chapter tab after opening entity
- [X] Test: clicking entity with no prior tab makes it active
- [X] Test: activeChapterSlug is cleared after clicking entity
