...
5. *Check the process guides* - If the task touches 3+ files, remind about [[file:multi-file-changes.org][Multi-File Changes]] process

Present a brief summary of the context gathered.

* Step 6: Transition to DOING
:PROPERTIES:
:CUSTOM_ID: transition-doing
:END:
...
3. *Summarize the work plan* - Restate what will be done, which files will change, and what the acceptance criteria are

If validation fails, show the errors and fix them before proceeding.

* Quick Mode
:PROPERTIES:
:CUSTOM_ID: quick-mode
:END:
...
- [[file:dashboard.org][Dashboard]] - For orientation and project overview
- [[file:multi-file-changes.org][Multi-File Changes]] - For complex cross-file work
- [[file:../agents/index.org][Agent Registry]] - All available agents
