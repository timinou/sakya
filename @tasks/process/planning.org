...
Break the work into atomic ITEMs following the [[file:../reference.org::#granularity][Task Granularity Guidelines]]:
...
:PROPERTIES:
:CUSTOM_ID: assign-agents
:END:

Match each ITEM to the agent best suited for the work. Consult the [[file:../agents/index.org][Agent Registry]] for available agents and their expertise.
...
:PROPERTIES:
:CUSTOM_ID: design-orchestration
:END:
...
:PROPERTIES:
:CUSTOM_ID: checkpoint-reference
:END:
...
- [[file:task-runner.org][Task Runner]] - For picking and starting individual tasks
- [[file:multi-file-changes.org][Multi-File Changes]] - For complex cross-file work
- [[file:../agents/index.org][Agent Registry]] - Available agents and expertise
- [[file:../reference.org][Reference Guide]] - Full PRD system documentation
- [[file:../reference.org::#granularity][Task Granularity Guidelines]] - Sizing individual ITEMs
