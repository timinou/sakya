...
Agent definitions live in =@tasks/agents/*.org=. For the full assignment matrix, see [[file:../agents/index.org::#matrix][Agent Registry: Assignment Matrix]].

* Step 3: Task Metrics
:PROPERTIES:
:CUSTOM_ID: task-metrics
:END:
...
- [[file:task-runner.org][Task Runner]] - For picking and starting a specific task
...
- [[file:../CLAUDE.md][CLAUDE.md]] - Claude Code integration guide
