...
** ITEM Create Tauri search commands
:PROPERTIES:
...
** ITEM Create SearchPalette component
:PROPERTIES:
...
** ITEM Create backlinks inspector section
:PROPERTIES:
...
** ITEM Implement wiki-link autocomplete
:PROPERTIES:
...
** ITEM Implement keyboard shortcuts
:PROPERTIES:
...
** ITEM Implement UI state persistence
:PROPERTIES:
...
** ITEM Create common UI components
:PROPERTIES:
