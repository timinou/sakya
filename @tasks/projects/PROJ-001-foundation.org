...
** DONE Create project launcher page
:PROPERTIES:
...
*** Acceptance Criteria
- [X] "Create Project" button opens name/path dialog
- [X] "Open Project" button opens native folder picker via Tauri
- [ ] Recent projects list (stored in app data)
- [X] =+layout.svelte=: Theme provider ($effect sets data-theme attribute)
- [X] =+layout.svelte=: Global CSS import
- [X] Successful create/open navigates to AppShell view
- [X] Error states for invalid project paths
