...
** ITEM Create Lexical theme and base configuration
:PROPERTIES:
...
** ITEM Create Markdown transformers and shortcuts plugin
:PROPERTIES:
...
** ITEM Create EditorTabs component
:PROPERTIES:
...
** ITEM Create Markdown I/O utilities
:PROPERTIES:
