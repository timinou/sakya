...
** ITEM Create Tauri schema commands
:PROPERTIES:
...
** ITEM Create default entity schemas
:PROPERTIES:
...
** ITEM Create Tauri entity instance commands
:PROPERTIES:
...
** ITEM Create BinderTree component
:PROPERTIES:
...
** ITEM Create EntityForm component
:PROPERTIES:
...
** ITEM Create interactive SpiderChart component
:PROPERTIES:
...
** ITEM Create SchemaEditor component
:PROPERTIES:
