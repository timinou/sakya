...
** ITEM Create StaleGuard utility and apply to project.svelte.ts
:PROPERTIES:
:CUSTOM_ID: ITEM-191
...
** ITEM Apply race guards to manuscript.svelte.ts and notes.svelte.ts
:PROPERTIES:
:CUSTOM_ID: ITEM-192
:AGENT: [[file:../agents/svelte-developer.org::#core][svelte-developer:core]]
:EFFORT: 2h
...
** ITEM Apply race guards to entities.svelte.ts, sessions.svelte.ts, ui.svelte.ts
:PROPERTIES:
:CUSTOM_ID: ITEM-193
:AGENT: [[file:../agents/svelte-developer.org::#core][svelte-developer:core]]
:EFFORT: 2h
...
** ITEM Add project-switch orchestration layer
:PROPERTIES:
:CUSTOM_ID: ITEM-194
:AGENT: [[file:../agents/svelte-developer.org::#core][svelte-developer:core]]
:EFFORT: 1h
