...
| Visual regression tests | testing-engineer | svelte-developer |
...
| crates/ | rust-architect |
| crates/sakya-crdt/src/marks.rs | lexical-specialist, rust-architect |
| src/lib/components/sync/ | svelte-developer |
| src/lib/stores/sync.svelte.ts | svelte-developer |
| deploy/ | rust-architect |
