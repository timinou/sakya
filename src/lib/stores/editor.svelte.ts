...
class EditorState {
  ...
  // Self-protecting: reads of this.tabs inside untrack() won't create reactive
  // dependencies when called from $effect blocks (BUG-006 structural fix).
  // Writes still trigger downstream effects normally.
