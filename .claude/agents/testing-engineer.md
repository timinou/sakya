...
description: "Testing Engineer agent. Master of test architecture for Svelte 5 + Tauri applications."
...
- AI-readable screenshot capture for Claude Code inspection
...
- `e2e/utils/screenshots.ts` for AI-readable screenshots
...
- Visual regression test suite and baselines
- AI-readable screenshot pipeline
...
- Creating or updating visual regression baselines
...
- Screenshot comparisons for every new page/layout
- Visual regression baselines committed and maintained
...
test('page matches baseline', async ({ page }) => {
  ...
  // AI-readable copy for Claude inspection
  await takeStepScreenshot(page, 'page', 'loaded');
});
```
...
## With Claude Code (AI Review)

- Visual tests save screenshots to `e2e/screenshots/`
- Claude reads PNGs via Read tool to verify layout
- Useful for autonomous review of UI changes
