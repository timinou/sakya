...
- [Testing Engineer](../agents/testing-engineer.org) — owns visual regression suite
- [Verification and Testing](../reference.org::#verification) — `visual` TEST<sub>PLAN</sub> value
