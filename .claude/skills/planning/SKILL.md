...
Break the work into atomic ITEMs following the [Task Granularity Guidelines](../reference.org::#granularity):
...
Match each ITEM to the agent best suited for the work. Consult the [Agent Registry](../agents/index.org) for available agents and their expertise.
...
- [Task Runner](task-runner.org) - For picking and starting individual tasks
- [Multi-File Changes](multi-file-changes.org) - For complex cross-file work
- [Agent Registry](../agents/index.org) - Available agents and expertise
- [Reference Guide](../reference.org) - Full PRD system documentation
- [Task Granularity Guidelines](../reference.org::#granularity) - Sizing individual ITEMs
